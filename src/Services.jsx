    ...
    <>
      <div className="relative justify-items-start">
        <img
          ...
          alt="img"
        className="h-[600px] w-screen bg-transparent"/>
        <div className="w-full absolute top-0 left-2 text-center mt-10">
          <h2 className="text-xl font-serif font-bold text-gray-50 text-left left-5">
            Quality Health Care
          </h2>
          <h2 className="text-xl font-serif py-4 text-gray-50 text-left left-5">
