  ...
  return (<div>
        <div className="w-full h-96">
          <img
            ...
            alt="nature image"
          />
          <div className="absolute inset-0 h-full w-fullss"></div>
          <div className="relative pt-28 text-center">
            <h2 className="block antialiased tracking-normal font-sans font-semibold leading-[1.3] text-green-200 mb-4 text-3xl lg:text-4xl">
              Contact Information
            </h2>
            ...
            <div className="py-12 flex justify-center rounded-xl border border-white bg-white shadow-md shadow-black/5 saturate-200">
              <div className="my-8 grid gap-6 px-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <p className="block antialiased font-sans text-base leading-relaxed text-inherit font-bold">
                    beyondhealthcare@hospital.co.in
                  </p>
                </div>
                <div className="flex items-center gap-4">
                </div>
